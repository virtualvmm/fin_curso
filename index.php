        ...
        <section id="Bienvenida" class="row">
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="list-group">
                    <div class="thumbnail">
                        <h1 class="list-group-item discret list-group-item-heading   text-center">ZoomZone</h1>

                        <div class="panel-body">
                            <h2>Bienvenido</h2>
                            <p>Zoomzone importa y distribuye articulos para fotografos, desde camaras, tripodes, flashes, filtros y todo tipo de accesorios.</p>
                        </div>
                    </div>
                </div>
            </article>
